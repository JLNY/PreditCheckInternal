...
function ap_question_metas($question_id = false)
{
    ...
    if (is_question()) {
        ...
        $prediction_time = ap_get_post_field('prediction_time');
        $metas['prediction_time'] = '<i class="apicon-clock"></i><i><time class="published updated">prediction time: ' . $prediction_time . '</time></i>';
    }
