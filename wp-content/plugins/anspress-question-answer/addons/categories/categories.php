...
class Categories extends \AnsPress\Singleton
{
    ...
    {
        add_submenu_page('anspress', __('Predictions Category', 'anspress-question-answer'), __('Category', 'anspress-question-answer'), 'manage_options', 'edit-tags.php?taxonomy=question_category');
    }
    ...
    public function ap_question_form_fields($form)
    {
        ...
        $form['fields']['category'] = array(
            ...
            'desc' => __('Select a people/entity that makes this prediction.', 'anspress-question-answer'),
            'type' => 'select',
            'options' => 'terms',
            'order' => 2,
