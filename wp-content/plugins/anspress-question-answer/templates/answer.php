...
if (ap_user_can_read_answer()) :
    ?>
    <div id="post-<?php the_ID(); ?>" class="answer<?php echo ap_is_selected() ? ' best-answer' : ''; ?>"
         apid="<?php the_ID(); ?>" ap="answer">
        <div class="ap-content" itemprop="suggestedAnswer<?php echo ap_is_selected() ? ' acceptedAnswer' : ''; ?>"
            ...
            <div class="ap-cell clearfix">
                <div class="ap-cell-inner">
                    <div class="ap-q-metas">
                        <span style="background: <?php switch (ap_get_post_field('trueorfalse')) {
                            case "true":
                                echo "green";
                                break;
                            case 'amber':
                            ...
                            case "false":
                                echo "red";
                                break;
                        } ?>"> <strong><?php echo ap_get_post_field('trueorfalse') ?></strong></span>
